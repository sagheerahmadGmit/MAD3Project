...
public class PlayerController : MonoBehaviour
{
    ...
    //get the player rigid body and velocity
    ...
    //increase the speed slowly over time
    public float increaseSpeed = 0.01f;

    //audioclips for gameover when player hits obstacle
    ...
    void Jump()
    {
        ...
        else if (playerJump == 0 && onGround)//if there is no input then the player keeps running on the ground
        {
            velocity.y = 0;
        }
        else//else start coming down slowly
        {
    ...
    public void KillPlayer(GameObject enemy)
    {
        ...
        //set the levelmanager enemy to obstacle who killed player
